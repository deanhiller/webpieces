...
public class TestIntegTimeoutConnection {
	...
	private static final Logger log = LoggerFactory.getLogger(TestIntegTimeoutConnection.class);
	...
	public void testIntegrationOfTimeoutAfterSslConnection() throws InterruptedException, ExecutionException, TimeoutException {
		...
		config.maxConnectToRequestTimeoutMs = 1000;
		MockRequestListener mockRequestListener = new MockRequestListener();
		HttpFrontend server = mgr.createHttpsServer(config, mockRequestListener, new SSLEngineFactoryForTest());
