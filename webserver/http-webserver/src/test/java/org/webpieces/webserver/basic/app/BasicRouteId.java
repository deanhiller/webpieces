...
public enum BasicRouteId implements RouteId {
	...
	REDIRECT_PAGE, RENDER_PAGE, SOME_ROUTE, REDIRECT2, THROW_NOT_FOUND, BAD_TEMPLATE, 
	JSON_ROUTE, NULL_ROUTE, REDIRECT_RAW_URL, REDIRECT_ABSOLUTE_URL, RENDER_PAGE2, SCOPED_ROOT, SCOPED_ROOT2 
