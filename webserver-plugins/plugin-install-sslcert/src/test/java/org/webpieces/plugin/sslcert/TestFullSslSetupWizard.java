...
public class TestFullSslSetupWizard extends AbstractWebpiecesTest {
	...
	public void testFullSuccessWizardWalkthrough() throws MalformedURLException {
		renderFirstPage("/@sslcert");
		postFirstPageAndEmail("/@sslcert/postEmail");
		renderStep2AskingForOrg("/@sslcert/step2");
		MockProxyAuthorization proxyAuth = postOrgAndPlaceOrderAndFinalizeOrder("/@sslcert/postStep2");
