...
public class BadRedirectRouteModule implements RouteModule {
	...
	public void configure(Router router, String packageName) {
		...
		router.addRoute(GET, "/user/{id}",  "org.webpieces.devrouter.api.SomeController.badRedirect", SOME_EXAMPLE);
