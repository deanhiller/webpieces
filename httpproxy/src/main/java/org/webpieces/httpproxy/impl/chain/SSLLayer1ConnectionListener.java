...
@Singleton
public class SSLLayer1ConnectionListener implements ConnectionListener {
	private static final Logger log = LoggerFactory.getLogger(SSLLayer1ConnectionListener.class);

	@Inject
	private SSLLayer1DataListener listener;
