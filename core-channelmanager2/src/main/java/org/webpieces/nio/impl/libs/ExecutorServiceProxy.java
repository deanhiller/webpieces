...
public class ExecutorServiceProxy implements StartableExecutorService {
...
//	private static final Logger log = Logger.getLogger(ExecutorServiceProxy.class.getName());
	...
	/**
     * @see org.webpieces.nio.api.libs.StartableExecutorService#containsThread(java.lang.Thread)
     */
