...
public class ChannelsFactoryImpl implements ChannelsFactory
{
    ...
    /**
     * @throws IOException 
     * @see org.webpieces.nio.api.testutil.chanapi.ChannelsFactory#open()
     */
    ...
    /**
     * @see org.webpieces.nio.api.testutil.chanapi.ChannelsFactory#open(java.nio.channels.SocketChannel)
     */
