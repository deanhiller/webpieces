...
//	private static final int NUM_BYTES_IN_CHAR = Character.SIZE/8;
	 ...
	 * and Writers have.
	 * 
	 * @see org.webpieces.nio.api.libs.BufferHelper#putString(java.nio.ByteBuffer, java.lang.String)
	 */
	public void putString(ByteBuffer b, String fullString) {
		...
		if (log.isTraceEnabled()) {
			log.trace("1byteBuf pos="+b.position()+"  lim="+b.limit()+"  remain="+b.remaining());
		}
		b.put(encodedString);
	...
	/**
	 * @see org.webpieces.nio.api.libs.BufferHelper#doneFillingBuffer(java.nio.ByteBuffer)
	 */
...
//		log.info("buffer='"+s+"'");
	...
	/**
	 * @see org.webpieces.nio.api.libs.BufferHelper#eraseBuffer(java.nio.ByteBuffer)
	 */
	...
	/**
	 * @see org.webpieces.nio.api.libs.BufferHelper#processForPacket(java.nio.ByteBuffer, java.nio.ByteBuffer)
	 */
